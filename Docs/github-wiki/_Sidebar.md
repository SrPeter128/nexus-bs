...
- [Start aici](Home-ro)
- [Instalare ușoară (.deb)](Install-from-APT-ro)
- [Build din surse](Build-from-Source-ro)
...
- [Inicio](Home-es)
- [Instalación fácil (.deb)](Install-from-APT-es)
- [Compilar desde fuente](Build-from-Source-es)
